...
public class NewsAdapter extends BaseAdapter {
    ...
    public NewsAdapter(Context context, List<RecentChat> lists, CustomListView customListView) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.tv_feel = (TextView) convertView.findViewById(R.id.user_feel);
            holder.tv_time = (TextView) convertView.findViewById(R.id.user_time);
        ...
        if (hashMaps.containsKey(path)) {
            ...
            ImgUtil.getInstance().loadBitmap(chat.getImgPath(), new OnLoadBitmapListener() {
                @Override
                public void loadImage(Bitmap bitmap, String path) {
                    ...
                    if (bitmap != null && iv != null) {
                        ...
                        if (!hashMaps.containsKey(path)) {
                            hashMaps.put(path, new SoftReference<>(bitmap));
                        }
                    }
                }
            });
